...
<a href="#">
        <img src="{{ asset('img/logo.png') }}" style="height:70px; margin-left:20px">
    </a>
</div>
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="/boq" class="nav-link">Bill Of Quantity</a></li>
          <li class="nav-item"><a href="/tenders" class="nav-link">Tenders</a></li>
          <li class="nav-item"><a href="/vendors" class="nav-link">Vendors</a></li>
          <li class="nav-item"><a href="/constructions" class="nav-link">Contructions</a></li>
          <li class="nav-item"><a href="/rnr" class="nav-link">Retention &amp; Recovery</a></li>
          </ul>
        {{-- <a href="#" class="br-menu-link">
          <div class="br-menu-item">
